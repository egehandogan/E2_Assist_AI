                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <p className={cn("text-xs leading-snug", !n.isRead ? "font-semibold text-gray-900" : "text-gray-700")}>
                            {n.title}
                          </p>
                        ...
                        {!n.isRead && (
                          <div className="flex-shrink-0 mt-1 w-2 h-2 bg-violet-500 rounded-full" />
                        )}
                      </div>
                    );
                  })
